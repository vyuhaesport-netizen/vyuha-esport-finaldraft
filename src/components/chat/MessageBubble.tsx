...
import { Check, CheckCheck, Reply, Trash2, Pencil, MoreVertical, Copy, Smile, X } from 'lucide-react';
        ...
        {replyTo && (
          ...
          >
            ...
            <div className="text-[11px] leading-tight">
              ...
              <span className={cn(
                "line-clamp-1",
                isOwn ? "text-white/60" : "text-foreground/60"
          ...
          {groupedReactions.length > 0 && (
            <div className={cn(
              ...
              {groupedReactions.map(([emoji, users]) => (
                ...
                >
                  <span>{emoji}</span>
                  {users.length > 1 && <span className="text-[10px] text-foreground/70">{users.length}</span>}
                </button>
              ))}
            </div>
          )}
          ...
          <div className={cn(
            ...
            {canModify && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align={isOwn ? 'end' : 'start'} className="w-32 bg-card border-border">

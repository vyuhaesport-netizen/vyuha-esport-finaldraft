...
const OrganizerHub = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="bg-gradient-to-r from-primary/90 to-primary text-primary-foreground p-4 sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <img src={vyuhaLogo} alt="Vyuha" className="h-8 w-8" />
          <div>
            <h1 className="text-xl font-bold">Organizer Dashboard</h1>
            <p className="text-sm text-primary-foreground/80">Manage your tournaments</p>
          </div>
        </div>
      </div>

      ...
      <div className="pb-40">
        ...
        <div className="px-4 py-4">
          ...
          {alreadyJoined ? (
           ...
           {/* Social Links Card - Show when user has joined */}
           {alreadyJoined && tournament && (tournament.youtube_link || tournament.instagram_link || tournament.whatsapp_link || tournament.discord_link) && (
             <Card className="mt-4 border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-primary/5">
               <CardHeader className="pb-2">
                 <CardTitle className="text-sm flex items-center gap-2">
                   <ExternalLink className="h-4 w-4 text-primary" />
                   Join Organizer's Community
                 </CardTitle>
                 <CardDescription className="text-xs">
                   Join these groups for updates and announcements by the organizers ASAP
                 </CardDescription>
               </CardHeader>
               <CardContent className="space-y-2 pb-3">
                 {tournament.whatsapp_link && (
                   <a 
                     href={tournament.whatsapp_link} 
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="flex items-center gap-3 p-2.5 rounded-lg border border-green-500/30 bg-green-500/10 hover:bg-green-500/20 transition-colors"
                   >
                     <MessageCircle className="h-5 w-5 text-green-500" />
                     <div className="flex-1">
                       <p className="text-xs font-semibold text-green-500">Join WhatsApp Group</p>
                       <p className="text-[10px] text-muted-foreground">Get live updates & room credentials</p>
                     </div>
                 ...
                 {tournament.discord_link && (
                   <a 
                     ...
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="flex items-center gap-3 p-2.5 rounded-lg border border-indigo-500/30 bg-indigo-500/10 hover:bg-indigo-500/20 transition-colors"
                   >
                     <DiscordIcon className="h-5 w-5 text-indigo-400" />
                     <div className="flex-1">
                       <p className="text-xs font-semibold text-indigo-400">Join Discord Server</p>
                       <p className="text-[10px] text-muted-foreground">Community chat & announcements</p>
                     </div>
                     <ExternalLink className="h-3.5 w-3.5 text-muted-foreground" />
                   </a>
                 )}
                 {tournament.youtube_link && (
                   <a 
                     ...
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="flex items-center gap-3 p-2.5 rounded-lg border border-red-500/30 bg-red-500/10 hover:bg-red-500/20 transition-colors"
                   >
                     <Youtube className="h-5 w-5 text-red-500" />
                     <div className="flex-1">
                       <p className="text-xs font-semibold text-red-500">Subscribe YouTube</p>
                       <p className="text-[10px] text-muted-foreground">Watch live streams & highlights</p>
                     </div>
                     <ExternalLink className="h-3.5 w-3.5 text-muted-foreground" />
                   </a>
                 )}
                 {tournament.instagram_link && (
                   <a 
                     ...
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="flex items-center gap-3 p-2.5 rounded-lg border border-pink-500/30 bg-pink-500/10 hover:bg-pink-500/20 transition-colors"
                   >
                     ...
                     <div className="flex-1">
                       <p className="text-xs font-semibold text-pink-500">Follow Instagram</p>
                       <p className="text-[10px] text-muted-foreground">Latest news & stories</p>
                     </div>
                     <ExternalLink className="h-3.5 w-3.5 text-muted-foreground" />
                   </a>
                 )}
      ...
      <>
        ...
        <Card>
          ...
          <CardContent className="text-xs space-y-1.5">
            ...
            <div className="flex justify-between">
              <span className="text-muted-foreground">Progression</span>
               <span className="font-medium">Top {tournament!.winners_per_room || 1} per room advances</span>
            </div>
          </CardContent>
        </Card>
      </>

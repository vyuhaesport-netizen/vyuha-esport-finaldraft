-- Create qualification trigger function for wallet transactions
...
BEGIN
  -- Only trigger for completed deposits or admin credits
  IF NEW.status != 'completed' THEN
    RETURN NEW;
  END IF;
  
  -- Check if this is a qualifying action
  ...
  -- Create wallet transaction for commission (separate to avoid recursion)

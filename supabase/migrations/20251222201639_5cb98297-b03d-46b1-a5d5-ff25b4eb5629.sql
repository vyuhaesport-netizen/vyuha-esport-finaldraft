-- Update process_tournament_join to block joining after registration deadline
...
-- Update process_team_tournament_join to block joining after registration deadline
